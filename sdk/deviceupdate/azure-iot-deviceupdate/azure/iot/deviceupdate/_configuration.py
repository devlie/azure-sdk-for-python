...
class DeviceUpdateClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
...
class DeviceManagementClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for DeviceManagementClient.
...
class InstanceManagementClientConfiguration:  # pylint: disable=too-many-instance-attributes,name-too-long
    """Configuration for InstanceManagementClient.
